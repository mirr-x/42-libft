...
The mandatory functions implement common C behavior for characters, strings, memory and IO. Below each subsection is its own table.
...
| `ft_toupper` | Convert lower-case to upper-case |
| `ft_tolower` | Convert upper-case to lower-case |
